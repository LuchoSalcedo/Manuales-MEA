      ...
      <div className="bg-blue-600 text-white px-3 sm:px-4 py-2 sm:py-3 rounded-t-lg flex justify-between items-center">
        ...
        {messages.length > 0 && (
          <button
            ...
            className="p-2 sm:p-2.5 min-w-[40px] min-h-[40px] sm:min-w-[44px] sm:min-h-[44px] flex items-center justify-center hover:bg-blue-700 rounded-lg transition-colors flex-shrink-0 ml-2"
